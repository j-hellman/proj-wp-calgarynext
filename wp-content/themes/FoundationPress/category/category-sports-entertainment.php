...
<div class="topic-container">
  ...
  <div class="topstory-heading topstory-entertainment link-hover"> <!-- topstory-entertainment set the background image -->
    <h3><a href="http://localhost/proj-wp-calgarynext/sports-entertainment/lebron-back-to-miami-again/">LeBron Back to Miami, AGAIN!</a></h3>
    <p>May 6, 2021</p>
  </div>
  <hr>
  <div class="subtopic">
  ...
  <div class="card-container">
    <div class="card-image">
      <img src="../../proj-wp-calgarynext\wp-content\themes\FoundationPress\src\assets\images\topic-entertainment\outside.jpg" alt="Safe Outside image">
    </div>
    <div class="card-wrap">
      <div class="card-title">
      ...
      <div>
        <button class="readMore-button" onclick="window.location.href='http:localhost/proj-wp-calgarynext/sports-entertainment/how-to-stay-safe-outside-during-covid-19-pandamic/'">READ MORE</button>
      </div>
    </div>
  </div>
  ...
  <div class="card-container">
    <div class="card-image">
      <img src="../../proj-wp-calgarynext\wp-content\themes\FoundationPress\src\assets\images\topic-entertainment\calgary.jpg" alt="Calgary image">
    </div>
    <div class="card-wrap">
      <div class="card-title">
      ...
      <div>
        <button class="readMore-button" onclick="window.location.href='http:localhost/proj-wp-calgarynext/sports-entertainment/enjoy-the-may-long-weekend-doing-different-things-in-calgary/'">READ MORE</button>
      </div>
    </div>
  </div>
