...
<div class="topic-container">
  ...
  <div class="topstory-heading topstory-business link-hover"> <!-- topstory-business set the background image -->
    <h3><a href="http://localhost/proj-wp-calgarynext/business/the-impending-market-crash/">The Impending Market Crash</a></h3>
    <p>May 6, 2021</p>
  </div>
  <hr>
  <div class="subtopic">
  ...
  <div class="card-container">
    <div class="card-image">
      <img src="../../proj-wp-calgarynext\wp-content\themes\FoundationPress\src\assets\images\topic-business\bitcoin.jpg" alt="Bitcoin image">
    </div>
    <div class="card-wrap">
  ...
  <div class="card-container">
    <div class="card-image">
      <img src="../../proj-wp-calgarynext\wp-content\themes\FoundationPress\src\assets\images\topic-business\laptop.jpg" alt="Laptop image">
    </div>
    <div class="card-wrap">
      <div class="card-title">
  ...
  <div class="card-container">
    <div class="card-image">
      <img src="../../proj-wp-calgarynext\wp-content\themes\FoundationPress\src\assets\images\topic-business\house.jpg" alt="House image">
    </div>
    <div class="card-wrap">
      <div class="card-title">
  ...
  <div class="card-container">
    <div class="card-image">
      <img src="../../proj-wp-calgarynext\wp-content\themes\FoundationPress\src\assets\images\topic-business\openshop.jpg" alt="Openshop image">
    </div>
    <div class="card-wrap">
      <div class="card-title">
      ...
      <div>
        <button class="readMore-button" onclick="window.location.href='http:localhost/proj-wp-calgarynext/business/small-businesses-urge-calgarians-to-shop-more/'">READ MORE</button>
      </div>
    </div>
  </div>
  ...
  <div class="card-container">
    <div class="card-image">
      <img src="../../proj-wp-calgarynext\wp-content\themes\FoundationPress\src\assets\images\topic-business\amazon.jpg" alt="Amazon image">
    </div>
    <div class="card-wrap">
      <div class="card-title">
      ...
      <div>
        <button class="readMore-button" onclick="window.location.href='http:localhost/proj-wp-calgarynext/business/amazon-postpones-prime-day/'">READ MORE</button>
      </div>
    </div>
  </div>
